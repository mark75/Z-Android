...
package com.zandroid.network.lib.entity.mine.content;


import com.zandroid.network.lib.entity.MIME;
...
public class FileBody extends AbstractContentBody {
	...
	public void writeTo(final OutputStream out, WriteByteListener listener)
			throws IOException {
		if (out == null) {
